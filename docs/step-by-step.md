...
##### Inspect available measurement and it's data:
...
##### Inspect available bucket and it's data:
...
#### Inspect available organization and it's data:
...
#### Inspect available subscription and it's data after creating it:
...
Final step is to inspect the results if the module actually did what it supposed to and uploaded data into **Influx-db**.
